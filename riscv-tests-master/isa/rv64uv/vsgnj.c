...
TEST_CASE(test1) {
  ...
  asm volatile ("vsgnj v2, v0, v1");
  VEC_CMP_F64(2, 0x1234567812345678, 0x9234567812345678, 0x1234567812345678, 0x9234567812345678);
}
...
TEST_CASE(test2) {
  ...
  asm volatile ("vsgnj v2, v0, v1");
  VEC_CMP_F32(2, 0x12345678, 0x92345678, 0x12345678, 0x92345678);
}
...
TEST_CASE(test3) {
  ...
  asm volatile ("vsgnj v2, v0, v1");
  VEC_CMP_F16(2, 0x1234, 0x9234, 0x1234, 0x9234);
}
...
TEST_CASE(test4) {
  ...
  asm volatile ("vsgnj v2, v0, v2, v1.t");
  VEC_CMP_F64(2, 0, 0x9234567812345678, 0, 0x9234567812345678);
}
...
TEST_CASE(test5) {
  ...
  asm volatile ("vsgnj v2, v0, v2, v1.f");
  VEC_CMP_F64(2, 0x1234567812345678, 0, 0x1234567812345678, 0);
}
