...
TEST_CASE(test1) {
  ...
  asm volatile ("vnmadd v3, v0, v1, v2");
  VEC_CMP_U32(3, 0xffffffff, 0xfffffffe, 0xffffffea);
}
...
TEST_CASE(test2) {
  ...
  asm volatile ("vnmadd v3, v0, v1, v2");
  VEC_CMP_U32(3, 0x00000001, 0x00000001, 0x00000001);
}
...
TEST_CASE(test3) {
  ...
  asm volatile ("vnmadd v2, v0, v1, v2");
  VEC_CMP_U32(2, 0xffffdc00, 0xffffdb80, 0xfffe0102, 0xfffe0102);
}
...
TEST_CASE(test4) {
  ...
  asm volatile ("vnmadd v2, v0, v1, v2");
  VEC_CMP_U32(2, 0x00000001, 0x00000000, 0x00000000, 0x00000001);
}
...
TEST_CASE(test5) {
  ...
  asm volatile ("vnmadd v3, v0, v1, v2");
  VEC_CMP_S32(3, 0x00000001, 0x00000000, 0xffffffec);
}
...
TEST_CASE(test6) {
  ...
  asm volatile ("vnmadd v3, v0, v1, v2");
  VEC_CMP_U32(3, 0x00000001, 0x00000001, 0x80400001);
}
...
TEST_CASE(test7) {
  ...
  asm volatile ("vnmadd v3, v0, v1, v2");
  VEC_CMP_S32(3, 0x00000000, 0x00008000, 0xffc08000);
}
...
TEST_CASE(test8) {
  ...
  asm volatile ("vnmadd v3, v0, v1, v2");
  VEC_CMP_U16(3, 0x0008, 0x0000, 0x8401);
}
...
TEST_CASE(test10) {
  ...
  asm volatile ("vnmadd v0, v0, v1, v2");
  VEC_CMP_U32(0, -100);
}
...
TEST_CASE(test11) {
  ...
  asm volatile ("vnmadd v1, v0, v1, v2");
  VEC_CMP_U32(1, -153);
}
...
TEST_CASE(test12) {
  ...
  asm volatile ("vnmadd v0, v0, v0, v0");
  VEC_CMP_U32(0, -182);
}
...
TEST_CASE(test13) {
  ...
  asm volatile ("vnmadd v0, v2, v3, v4, v1.t");
  VEC_CMP_U32(0, 0x00000000, 0xefefefef, 0x00000000);
}
...
TEST_CASE(test14) {
  ...
  asm volatile ("vnmadd v0, v2, v3, v4, v1.f");
  VEC_CMP_U32(0, 0xefefeff0, 0x00000000, 0xefefefdb);
}
