...
TEST_CASE(test1) {
  ...
  asm volatile ("vmadd v3, v0, v1, v2");
  VEC_CMP_U32(3, 0x00000001, 0x00000002, 0x00000016);
}
...
TEST_CASE(test3) {
  ...
  VEC_CMP_U32(2, 0x00002400, 0x00002480, 0x0001fefe, 0x0001fefe);
}
...
TEST_CASE(test4) {
  ...
  asm volatile ("vmadd v2, v0, v1, v2");
  VEC_CMP_U32(2, 0xffffffff, 0x00000000, 0x00000000, 0xffffffff);
}
...
TEST_CASE(test5) {
  ...
  asm volatile ("vmadd v3, v0, v1, v2");
  VEC_CMP_S32(3, 0xffffffff, 0x00000000, 0x00000014);
}
...
TEST_CASE(test6) {
  ...
  asm volatile ("vmadd v3, v0, v1, v2");
  VEC_CMP_S32(3, 0xffffffff, 0xffffffff, 0x7fbfffff);
}
...
TEST_CASE(test7) {
  ...
  asm volatile ("vmadd v3, v0, v1, v2");
  VEC_CMP_S32(3, 0x00000000, 0xffff8000, 0x003f8000);
}
...
TEST_CASE(test8) {
  ...
  asm volatile ("vmadd v3, v0, v1, v2");
  VEC_CMP_U16(3, 0xfff8, 0x0000, 0x7bff);
}
...
TEST_CASE(test10) {
  ...
  asm volatile ("vmadd v0, v0, v1, v2");
  VEC_CMP_U32(0, 100);
}
...
TEST_CASE(test11) {
  ...
  VEC_VLD_VREG_U32(2, -1);

  asm volatile ("vmadd v1, v0, v1, v2");
  VEC_CMP_U32(1, 153);
}
...
TEST_CASE(test12) {
  ...
  asm volatile ("vmadd v0, v0, v0, v0");
  VEC_CMP_U32(0, 182);
}
...
TEST_CASE(test13) {
  ...
  asm volatile ("vmadd v0, v2, v3, v4, v1.t");
  VEC_CMP_U32(0, 0x00000000, 0x10101011, 0x00000000);
}
...
TEST_CASE(test14) {
  ...
  asm volatile ("vmadd v0, v2, v3, v4, v1.f");
  VEC_CMP_U32(0, 0x10101010, 0x00000000, 0x10101025);
}
...
TEST_CASE(test15) {
  ...
  VEC_VLD_VREG_U64(2, 0xffffffffffffffff, 0xffffffffffffffff, 0xffffffffffffffff);

  asm volatile ("vmadd v3, v0, v1, v2");
  VEC_CMP_U64(3, 0xffffffffffffffff, 0xffffffffffffffff, 0x00003fffffffffff);
}
...
TEST_CASE(test16) {
  ...
  asm volatile ("vmadd v3, v0, v1, v2");
  VEC_CMP_F64(3, _d(3.5).i, _d((double)(-1.0) * (double)(-1235.1) + (double)(1.1)).i, _d(-12.0).i);
}
...
TEST_CASE(test17) {
  ...
  asm volatile ("vmadd v3, v0, v1, v2");
  VEC_CMP_F32(3, _f(3.5).i, _f(1236.2).i, _f(-12.0).i);
}
...
TEST_CASE(test18) {
  ...
  asm volatile ("vmadd v3, v0, v1, v2");
  VEC_CMP_F16(3, _h(3.5).i, _h(1236.2).i, _h(-12.0).i);
}
