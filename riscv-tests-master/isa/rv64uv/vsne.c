...
TEST_CASE(test4) {
  ...
  VEC_VLD_VREG_S32(0, 0x0000ffff, 0x0000ffff, 0xffff8000, 0x00007fff);
  VEC_VLD_VREG_S32(1, 0xffffffff, 0x0000ffff, 0xffff8000, 0x00007fff);

  asm volatile ("vsne v2, v0, v1");

  VEC_CMP_U32(2, 1, 0, 0, 0);
}
...
TEST_CASE(test8) {
  ...
  asm volatile ("vsne v0, v2, v3, v1.t");
  VEC_CMP_U32(0, 0, 0, 1);
}
...
TEST_CASE(test9) {
  ...
  asm volatile ("vsne v0, v2, v3, v1.f");
  VEC_CMP_U32(0, 0, 0, 0);
}
