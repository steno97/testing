...
TEST_CASE(test1) {
  ...
  VEC_VLD_VREG_U64(1, 0x000000000f0f0f0f, 0x00000000f0f0f0f0, 0x000000000f0f0f0f, 0x00000000f0f0f0f0);

  asm volatile ("vand v2, v0, v1");
  VEC_CMP_U64(2, 0x000000000f000f00, 0x0000000000f000f0, 0x00000000000f000f, 0x00000000f000f000);
}
...
TEST_CASE(test2) {
  ...
  asm volatile ("vand v0, v0, v1");
  VEC_CMP_U32(0, 0x0f000f00);
}
...
TEST_CASE(test5) {
  ...
  asm volatile ("vand v0, v2, v3, v1.t");
  VEC_CMP_U32(0, 0x00000f00, 0x00000000, 0x0000000f, 0x0000f000);
}
...
TEST_CASE(test6) {
  ...
  asm volatile ("vand v0, v2, v3, v1.f");
  VEC_CMP_U32(0, 0x00000000, 0x000000f0, 0x00000000, 0x00000000);
}
