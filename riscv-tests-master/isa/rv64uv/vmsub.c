...
TEST_CASE(test1) {
  ...
  asm volatile ("vmsub v3, v0, v1, v2");
  VEC_CMP_U32(3, 0xffffffff, 0x00000000, 0x00000014);
}
...
TEST_CASE(test3) {
  ...
  asm volatile ("vmsub v2, v0, v1, v2");
...
TEST_CASE(test4) {
  ...
  asm volatile ("vmsub v2, v0, v1, v2");
  VEC_CMP_U32(2, 0x00000001, 0xfffffffe, 0x00000002, 0xffffffff);
}
...
TEST_CASE(test5) {
  ...
  asm volatile ("vmsub v3, v0, v1, v2");
  VEC_CMP_S32(3, 0x00000001, 0x00000002, 0x00000016);
}
...
TEST_CASE(test6) {
  ...
  asm volatile ("vmsub v3, v0, v1, v2");
  VEC_CMP_U32(3, 0x00000001, 0x00000001, 0x7fc00001);
}
...
TEST_CASE(test7) {
  ...
  asm volatile ("vmsub v3, v0, v1, v2");
  VEC_CMP_S32(3, 0x00000000, 0x00008000, 0x00408000);
}
...
TEST_CASE(test8) {
  ...
  asm volatile ("vmsub v3, v0, v1, v2");
  VEC_CMP_U16(3, 0x0008, 0x0000, 0x7c01);
}
...
TEST_CASE(test10) {
  ...
  asm volatile ("vmsub v0, v0, v1, v2");
  VEC_CMP_U32(0, 100);
}
...
TEST_CASE(test11) {
  ...
  asm volatile ("vmsub v1, v0, v1, v2");
  VEC_CMP_U32(1, 155);
}
...
TEST_CASE(test12) {
  ...
  asm volatile ("vmsub v0, v0, v0, v0");
  VEC_CMP_U32(0, 156);
}
...
TEST_CASE(test13) {
  ...
  asm volatile ("vmsub v0, v2, v3, v4, v1.t");
  VEC_CMP_U32(0, 0x00000000, 0xefefeff1, 0x00000000);
}
...
TEST_CASE(test14) {
  ...
  asm volatile ("vmsub v0, v2, v3, v4, v1.f");
  VEC_CMP_U32(0, 0xefefeff0, 0x00000000, 0xefeff005);
}
...
TEST_CASE(test15) {
  ...
  asm volatile ("vmsub v3, v0, v1, v2");
  VEC_CMP_U64(3, 0x0000000000000001, 0x0000000000000001, 0x0000400000000001);
}
...
TEST_CASE(test16) {
  ...
  asm volatile ("vmsub v3, v0, v1, v2");
  VEC_CMP_F64(3, _d(1.5).i, _d(1234).i, _d(-8.0).i);
}
