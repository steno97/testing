...
TEST_CASE(test1) {
  ...
  asm volatile ("vmin v2, v0, v1");
  VEC_CMP_U32(2, 0x00000000, 0x00000001, 0x00000003);
}
...
TEST_CASE(test2) {
  ...
  asm volatile ("vmin v2, v0, v1");
  VEC_CMP_U32(2, 0x00000000, 0x00000000, 0x80000000);
}
...
TEST_CASE(test3) {
  ...
  VEC_CMP_U16(2, 0x0000, 0x0000, 0x8000);
}
...
TEST_CASE(test4) {
  ...
  asm volatile ("vmin v2, v0, v1");
  VEC_CMP_U32(2, 0x00000000, 0x00000000, 0x00007fff);
}
...
TEST_CASE(test5) {
  ...
  asm volatile ("vmin v2, v0, v1");
  VEC_CMP_U32(2, 0x0000007f, 0x00007fff);
}
...
TEST_CASE(test6) {
  ...
  asm volatile ("vmin v2, v0, v1");
  VEC_CMP_U32(2, 0x00000000, 0x00000001, 0xffffffff);
}
...
TEST_CASE(test8) {
  ...
  asm volatile ("vmin v1, v0, v1");
  VEC_CMP_U32(1, 0x00000000, 0x00000001, 0x00000003);
}
...
TEST_CASE(test10) {
  ...
  VEC_VLD_VREG_U32(1, 0x01, 0xf0, 0xff);
  VEC_VLD_VREG_U32(2, 0x00000008, 0x00000001, 0x00000003);
  VEC_VLD_VREG_U32(3, 0x00000008, 0x00000001, 0x00000007);

  asm volatile ("vmin v0, v2, v3, v1.t");
  VEC_CMP_U32(0, 0x00000008, 0x00000000, 0x00000003);
}
...
TEST_CASE(test11) {
  ...
  asm volatile ("vmin v0, v2, v3, v1.f");
...
TEST_CASE(test12) {
  ...
  asm volatile ("vmin v2, v0, v1");
  VEC_CMP_S32(2, 0x00000000, 0x00000001, 0x00000003);
}
...
TEST_CASE(test13) {
  ...
  asm volatile ("vmin v2, v0, v1");
  VEC_CMP_S32(2, 0xffff8000, 0x80000000, 0x80000000);
}
...
TEST_CASE(test14) {
  ...
  VEC_CMP_S16(2, 0xff80, 0x8000, 0x8000);
}
...
TEST_CASE(test15) {
  ...
  asm volatile ("vmin v2, v0, v1");
  VEC_CMP_S32(2, 0x00000000, 0x00000000, 0x00007fff);
}
...
TEST_CASE(test16) {
  ...
  asm volatile ("vmin v2, v0, v1");
  VEC_CMP_S32(2, 0xffff8000, 0xffffff80);
}
...
TEST_CASE(test17) {
  ...
  asm volatile ("vmin v2, v0, v1");
  VEC_CMP_S32(2, 0xffffffff, 0xffffffff, 0xffffffff);
}
...
TEST_CASE(test18) {
  ...
  asm volatile ("vmin v2, v0, v1");
  VEC_CMP_S64(2, 0xffffffffffffffff, 0xffffffffffffffff, 0xffffffffffffffff);
}
...
TEST_CASE(test19) {
  ...
  asm volatile ("vmin v2, v0, v1");
  VEC_CMP_F64(2, _d(1.234).i, _d(-1.234e10).i, _d(3.1415926e-1).i);
}
...
TEST_CASE(test20) {
  ...
  asm volatile ("vmin v3, v0, v2, v1.t");
  VEC_CMP_F32(3, 0, _f(-1.234e10).i, 0);
}
...
TEST_CASE(test21) {
  ...
  asm volatile ("vmin v3, v0, v2, v1.f");
  VEC_CMP_F32(3, _f(1.234).i, 0, _f(3.1415926e-1).i);
}
...
TEST_CASE(test22) {
  ...
  asm volatile ("vmin v2, v0, v1");
  VEC_VLD_VREG_F64(1, _d(1.0).i, _d(-1235.1).i, _d(-1235.1).i, _d(-1235.1).i, _d(0.00000001).i, _d(-2.0).i);
}
